...
with st.form("hornacinas_form"):
    ...
    with c1:
        ...
        ancho_mm = st.number_input("Ancho (mm)", min_value=1, value="", step=1)
        alto_mm = st.number_input("Alto (mm)", min_value=1, value="", step=1)
        fondo_mm = st.number_input("Fondo (mm)", min_value=1, value="", step=1)

    with c2:
        num_baldas = st.number_input("Cantidad de baldas", min_value=0, value="", step=1)
